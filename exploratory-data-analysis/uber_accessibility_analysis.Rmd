...
```{r}
modelo_desvpad <- lm(
  desvpad_amostral ~ QTLINBUS2018 + KMLINBUS2018 + QTPONTBUS2018 + QTESTMETRO2018 +
    RENDP2010 + ARE1 + POP2018 + DENPOP2018 + DOMP2018 + ESTAB2016 +
    EMP2016 + PNBRAN2010 + TEMP2010_5MIN + TEMP2010_30MIN + TEMP2010_60MIN +
    TEMP2010_120MIN + TEMP2010_121MIN + TEMP2010_0MIN + PDOMC2010 + PDOMM2010,
  data = dados
...
```{r}
modelo_stepwise_desvpad <- step(modelo_desvpad, direction = "both", trace = FALSE)
...
```{r}
knitr::kable(summary(modelo_completo)$coefficients, caption = "Coeficientes do Modelo Completo") 
```

## Tabela de VIF do Modelo Completo
```{r}
knitr::kable(as.data.frame(vif(modelo_completo)), caption = "VIF do Modelo Completo") 
```

## Tabela de Coeficientes do Modelo Stepwise
```{r}
knitr::kable(summary(modelo_stepwise)$coefficients, caption = "Coeficientes do Modelo Stepwise") 
```

## Tabela de VIF do Modelo Stepwise
```{r}
knitr::kable(as.data.frame(vif(modelo_stepwise)), caption = "VIF do Modelo Stepwise") 
```
